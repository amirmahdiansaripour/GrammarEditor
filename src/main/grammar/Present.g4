...
//        (PREPOSITION SPACE {object += ($PREPOSITION.text + " ");})? (PREPOSITION SPACE {object += ($PREPOSITION.text + " ");})?
        ...
        {String object = "";}
        (
        (SPACE object[$s, false, ""])? |
        (SPACE object[$s, false, ""] SPACE PREPOSITION {object += ($PREPOSITION.text + " ");} SPACE(PREPOSITION {object += ($PREPOSITION.text + " ");}
         SPACE)? object[$s, false, object])?
        )
